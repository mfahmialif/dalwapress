...
.editor-root[data-theme="dark"] {
  --bg-main: #0B1120; --bg-sidebar: #0B1120; --bg-header: rgba(11,17,32,.92); --bg-card: #141d38; --bg-input: #141d38; --border: #1c2850; --border-light: #243362; --text-heading: #fff; --text-body: #cbd5e1; --text-muted: #64748b; --text-btn: #020617; --color-accent: #fbbf24; --hover-nav-bg: rgba(251,191,36,.08); --shadow-card: 0 4px 24px rgba(0,0,0,.4),0 1px 3px rgba(0,0,0,.2); --toggle-bg: #141d38; --toggle-text: #fbbf24;
}
.editor-root[data-theme="light"] {
  --bg-main: #eef2f7; --bg-sidebar: #eef2f7; --bg-header: rgba(238,242,247,.92); --bg-card: #fff; --bg-input: #e2e8f0; --border: #dce3ec; --border-light: #cbd5e1; --text-heading: #0f172a; --text-body: #475569; --text-muted: #94a3b8; --text-btn: #0f172a; --color-accent: #fbbf24; --hover-nav-bg: rgba(251,191,36,.12); --shadow-card: 0 4px 24px rgba(0,0,0,.07),0 1px 3px rgba(0,0,0,.04); --toggle-bg: #e2e8f0; --toggle-text: #475569;
}
...
.collapse-pill{background:var(--bg-card);border:1px solid var(--border);color:var(--text-muted);opacity:0;transform:scale(.8);box-shadow:0 2px 8px rgba(0,0,0,.25)}.group\/sidebar:hover .collapse-pill{opacity:1;transform:scale(1)}.collapse-pill:hover{background:var(--color-accent);color:var(--text-btn);border-color:var(--color-accent);box-shadow:0 0 12px rgba(251,191,36,.4);transform:scale(1.15)!important}
