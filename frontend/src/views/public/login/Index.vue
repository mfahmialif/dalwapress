    ...
    <div class="grid min-h-screen lg:grid-cols-[1.08fr_0.92fr]">
      <section class="relative hidden overflow-hidden lg:block">
        ...
        <div class="relative z-10 flex h-full flex-col justify-between p-12 xl:p-16">
          ...
          <div class="max-w-2xl">
            <p class="mb-5 inline-flex items-center gap-2 rounded-full border border-sky-300/30 bg-sky-300/10 px-4 py-2 text-sm font-bold text-sky-100">
      ...
      <section class="flex min-h-screen items-center justify-center px-5 py-8 sm:px-8">
        <div class="w-full max-w-[460px]">
          ...
          <div class="rounded-2xl border border-white/10 bg-white/[0.06] p-6 shadow-2xl shadow-black/30 backdrop-blur sm:p-8">
            <div class="mb-8">
              <p class="text-sm font-bold uppercase tracking-[0.2em] text-sky-300">Secure Login</p>
            ...
            <form @submit.prevent="handleLogin" class="flex flex-col gap-5">
              ...
              <div class="flex flex-wrap items-center justify-between gap-3">
                ...
                <router-link to="/" class="text-sm font-bold text-sky-300 transition hover:text-sky-200">
                  Kembali ke web
                </router-link>
              </div>
              ...
              <button
                type="submit"
                :disabled="isLoading"
                class="mt-2 inline-flex h-13 items-center justify-center gap-2 rounded-xl bg-sky-400 px-5 font-black text-[#07111f] shadow-lg shadow-sky-950/20 transition hover:bg-sky-300 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60"
              >
